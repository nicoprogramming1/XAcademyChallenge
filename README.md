...
| Listar jugadores                    | HU005     | Usuario      | Alta     | Como usuario, quiero poder ver una lista de todos los jugadores para tener acceso rápido a sus perfiles.                   | La lista debe estar paginada y traer 9 jugadores por página.
- Debe tener un navegador para cambiar la página actual.
- Los jugadores deben exhibir su foto, nombre, nacionalidad, club, edad y el nivel de skill.
- Al hacer click en un jugador debe redireccionar a HU004 con el id de dicho jugador |
